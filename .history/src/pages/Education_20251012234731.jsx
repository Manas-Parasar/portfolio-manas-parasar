        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 subtle">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Computer Organization and Assembly Language (CSC230)</li>
            </ul>
            <h4 className="font-semibold mb-2 mt-4">Mathematics</h4>
            <ul className="list-disc list-inside space-y-1">
              <li>Geometry 1-2</li>
              <li>Algebra 3-4</li>
              ...
              <li>Calculus with Analytic Geometry III (MAT240)</li>
              <li>Discrete Mathematical Structures (MAT227)</li>
            </ul>
          </div>
          <div>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>Biology 1-2</li>
              <li>Chemistry 1-2</li>
              <li>General Chemistry I (CHM151)</li>
              <li>General Chemistry Laboratory I (CHM151LL)</li>
              <li>General Chemistry II (CHM152)</li>
              <li>General Chemistry Laboratory II (CHM152LL)</li>
            </ul>
            <h4 className="font-semibold mb-2 mt-4">Electives</h4>
            <ul className="list-disc list-inside space-y-1">
