...
export default function About() {
  return (
    <div className="grid md:grid-cols-3 gap-8">
      <div className="md:col-span-1 glass rounded-3xl p-6 flex flex-col items-center text-center">
        <img
          src={MyPortrait}
          alt="Portrait"
          className="rounded-2xl object-cover h-64 w-full shadow-lg hover:scale-105 transition-transform"
        />
      ...
      <div className="md:col-span-2 space-y-6">
        <div className="glass rounded-3xl p-6">
          ...
          <p className="subtle">
            ...
            service and innovation. Recent projects include full-stack apps, AI
            experiments, and tools that empower students and communities.
          </p>
        </div>
        ...
        <div className="glass rounded-3xl p-6">
          ...
          <ul className="subtle list-disc list-inside space-y-1">
            ...
            <li>Volunteer: Teacher's Assistant</li>
