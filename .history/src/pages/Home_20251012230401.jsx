      ...
      >
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <ProjectCard
            ...
            desc="Full-stack soccer management game with Java simulation engine, Node.js API, and MongoDB. Features team building, tactical systems, AI opponents, and live match simulation."
            tags={[
              "Java",
              "JavaScript",
              "HTML",
