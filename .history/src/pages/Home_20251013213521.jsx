      ...
      >
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            {
              title: "Coding Club Founder/Instructor",
              desc: "Coach students in Scratch, HTML, CSS, Python, and Java through routinely meetings.",
            },
            {
              title: "Engineering Club President",
              desc: "Prototyped devices, mentored members, and introduced competitions.",
            },
          ].map((c) => (
            <div key={c.title} className="glass rounded-3xl p-5 block">
              ...
              {c.title === "Coding Club Founder/Instructor" && (
